 ...
 *
 *Adapted for Heltec esp32-lora  by Lucio
 *******************************************************************************/
...
static const u4_t DEVADDR = 0xAB000003 ; // <-- Change this address for every node!
...
const lmic_pinmap lmic_pins = {
    ...
    //.dio = {26, 33, 32}, //v1  pins
    .dio = {26, 34, 35}, //v2 usa pins
};
